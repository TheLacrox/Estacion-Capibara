...
public enum HispaniaATMUiKey : byte
{
    Key
}
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMState : BoundUserInterfaceState
{
    public int Balance;
    public bool Enabled;
    ...
    public HispaniaATMState(int balance, bool enabled, string? accountName, bool hasIdInserted, bool hasIdButNoAccount)
    {
        Balance = balance;
        Enabled = enabled;
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMWithdrawMessage : BoundUserInterfaceMessage
{
    public int Amount;

    public HispaniaATMWithdrawMessage(int amount)
    {
        Amount = amount;
    }
}
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMDepositMessage : BoundUserInterfaceMessage
{
}
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMInsertMessage : BoundUserInterfaceMessage
{
}
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMEjectMessage : BoundUserInterfaceMessage
{
}
...
/// </summary>
[Serializable, NetSerializable]
public sealed class HispaniaATMCreateAccountMessage : BoundUserInterfaceMessage
{
}
