...
public sealed partial class HispaniaATMWindow : FancyWindow
{
    ...
    public void UpdateState(HispaniaATMState state)
    {
        if (!state.HasIdInserted)
            AccountLabel.Text = Loc.GetString("hispania-atm-no-id");
        else
