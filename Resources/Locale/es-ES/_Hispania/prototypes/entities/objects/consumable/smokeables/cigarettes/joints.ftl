ent-Joint = porro
    .desc = Un rollito de materia vegetal seca envuelto en papel fino.
...
ent-BluntRainbow = blunt
    .desc = Un rollito de materia vegetal seca envuelto en una hoja de tabaco seca. Parece colorido por dentro.
