ent-WiredBucketBase = cubo con cables
    .desc = Un cubo con cables adjuntos para usarlo mejor como barboquejo.

ent-SlicedBucketBase = cubo con ranura
    .desc = Un cubo con una ranura de visión cortada en el lateral.
