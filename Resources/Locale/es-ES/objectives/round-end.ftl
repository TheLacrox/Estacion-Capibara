...
objectives-round-end-result = {$count ->
    [one] Hubo un {$agent}.
    *[other] Hubo {$count} {MAKEPLURAL($agent)}.
}
...
objectives-objective-partial-failure = {$objective} | [color=orange]¡Fallo parcial![/color] ({TOSTRING($progress, "P0")})
objectives-objective-fail = {$objective} | [color=red]¡Fallo![/color] ({TOSTRING($progress, "P0")})
