...
chat-language-Chicken-name = Gallina
chat-language-Cow-name = Vaca
chat-language-Crab-name = Cangrejo
chat-language-Deer-name = Ciervo
chat-language-Dog-name = Perro
chat-language-Duck-name = Pato
chat-language-Eldritch-name = Eldritch
chat-language-Fox-name = Zorro
chat-language-Hissing-name = Siseo
chat-language-Kangaroo-name = Canguro
chat-language-Kobold-name = Kobold
chat-language-Monkey-name = Mono
chat-language-Mouse-name = Ratón
chat-language-Penguin-name = Pingüino
chat-language-Pig-name = Cerdo
