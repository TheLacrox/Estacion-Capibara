...
## Sistema TTS
tts-examine-voice = Voz: {$voice}
tts-not-available = TTS no está disponible.
tts-voice-not-found = Voz no encontrada.
...
tts-popup-enable = Activar TTS
tts-popup-disable = No gracias
