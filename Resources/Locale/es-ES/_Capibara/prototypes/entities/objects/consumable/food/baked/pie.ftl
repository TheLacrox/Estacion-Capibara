...
ent-FoodPieBaklavaSlice = porción de baklava
    .desc = Una porción de un delicioso aperitivo saludable hecho de capas de nueces con pan delgado.
...
ent-FoodPiePlump = tarta plump
    .desc = Apuesto a que te gustan las cosas hechas con plump helmets.

ent-FoodTartGrape = tartaleta de uva
    .desc = Un sabroso postre que te recuerda el vino que no hiciste.

ent-FoodTartGapple = tartaleta streusel de manzana dorada
    .desc = Un sabroso postre que no pasará por un detector de metales.

ent-FoodTartCoco = tartaleta de lava de chocolate
    .desc = Un sabroso postre hecho de chocolate, con núcleo líquido.
