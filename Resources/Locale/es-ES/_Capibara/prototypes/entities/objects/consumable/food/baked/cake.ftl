...
ent-FoodCakeCarrotSlice = porción de tarta de zanahoria
    .desc = Porción de zanahoria de tarta de zanahoria. Las zanahorias son buenas para los ojos.

ent-FoodCakeBrain = tarta de cerebro
    .desc = Una cosa blanda con forma de tarta.
...
ent-FoodCakeCheese = tarta de queso
    .desc = PELIGROSAMENTE queso.

ent-FoodCakeCheeseSlice = porción de tarta de queso
    .desc = Una porción de pura satisfacción queso.
...
ent-FoodCakeLemoonSlice = fragmento de tarta lemoon
    .desc = Un fragmento de luna, tiene olor a leche.
...
ent-FoodCakePumpkin = tarta de calabaza y especias
    .desc = Una tarta hueca con calabaza real.

ent-FoodCakePumpkinSlice = porción de tarta de calabaza y especias
    .desc = Una porción picante de bondad de calabaza.
...
ent-FoodCakeVanilla = tarta de vainilla
    .desc = Una tarta con glaseado de vainilla.

ent-FoodCakeVanillaSlice = porción de tarta de vainilla
    .desc = Una porción de tarta con glaseado de vainilla.

ent-FoodCakeClown = tarta de payaso
    .desc = Una tarta graciosa con cara de payaso.

ent-FoodCakeClownSlice = porción de tarta de payaso
    .desc = Una porción de malos chistes y accesorios tontos.

ent-FoodCakeSpaceman = tarta del astronauta
    .desc = Una tarta con glaseado de trompeta de astronauta.

ent-FoodCakeSpacemanSlice = porción de tarta del astronauta
    .desc = Una tarta con glaseado de trompeta de astronauta.

ent-MobCatCake = cak
    .desc = Es una tarta. Es un gato. Es un cak.
...
ent-FoodCakeCotton = tarta de algodón
    .desc = Una tarta con glaseado de fibra y un montón de algodón encima.

ent-FoodCakeCottonSlice = porción de tarta de algodón
    .desc = Una porción de tarta de algodón. Puedes simplemente lamer el glaseado, está bien.

ent-FoodCakeBerryDelight = delicia de bayas
    .desc = Esta es una tarta que se acerca.

ent-FoodCakeBerryDelightSlice = porción de delicia de bayas
    .desc = Clava un tenedor, tu hambre en aislamiento.
