ent-Stunbaton = porra eléctrica
    .desc = Una porra eléctrica para incapacitar personas. Usarla para causar daño activo se considera de mal gusto.

ent-Truncheon = porra
    .desc = Una porra rígida con tachuelas de acero, diseñada para causar daño.
