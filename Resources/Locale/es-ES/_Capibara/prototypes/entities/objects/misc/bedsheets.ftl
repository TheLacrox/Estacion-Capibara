...
ent-BedsheetCE = sábana del JI
    .desc = Está decorada con el emblema de una llave inglesa. Es muy reflectante y resistente a las manchas, así que no hay que preocuparse por arruinarla con aceite.

ent-BedsheetCentcom = sábana de CentComm
    .desc = Tejida con nanohilo avanzado para abrigar y además muy decorada, imprescindible para todos los oficiales.

ent-BedsheetClown = sábana del payaso
    .desc = Una manta arcoíris con una máscara de payaso tejida. Huele levemente a plátanos.

ent-BedsheetCMO = sábana del JMO
...
ent-BedsheetHOS = sábana del JdSeg
...
ent-BedsheetMime = sábana del mimo
    .desc = Una manta a rayas muy relajante. Todo el ruido parece desvanecerse cuando estás tapado con ella.
