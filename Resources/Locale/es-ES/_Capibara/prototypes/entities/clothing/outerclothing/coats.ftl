ent-ClothingOuterCoatBomber = cazadora bomber
    .desc = Una gruesa y desgastada cazadora de cuero bomber de la Segunda Guerra Mundial.

ent-ClothingOuterCoatDetective = gabardina de detective
    .desc = Una gabardina multiusos del siglo XVIII. Quien la lleva va muy en serio.

ent-ClothingOuterCoatDetectiveLoadoutGrey = gabardina noir
    .desc = Ah, tu gabardina de confianza. Tiene algún que otro desgarrón aquí y allá, dándole un aspecto más acorde con los tiempos. O al menos eso te dijiste cuando te enteraste de que repararla te costaría 200 spesos.

ent-ClothingOuterCoatGentle = abrigo elegante
    .desc = Un abrigo elegante para un caballero, o dama.

ent-ClothingOuterCoatHoSTrench = gabardina blindada del jefe de seguridad
    .desc = Un abrigo largo mejorado con una aleación especial para algo de protección extra y estilo para quienes tienen una presencia imponente.
...
ent-ClothingOuterCoatWarden = chaqueta blindada del alguacil
    .desc = Una chaqueta resistente y utilitaria diseñada para proteger al alguacil de cualquier amenaza en la celda.

ent-ClothingOuterDameDane = abrigo yakuza
    .desc = Viernes...

ent-ClothingOuterClownPriest = túnicas de la Madre del Honk
    .desc = Pensadas para un payaso de la iglesia.

ent-ClothingOuterDogi = dogi samurai
    .desc = El dogi es un tipo de ropa tradicional japonesa. Está hecho de tela pesada y duradera, es práctico en combate y elegante en apariencia. Está decorado con intrincados patrones y bordados en la espalda.

ent-ClothingOuterCoatParamedicWB = cortavientos de paramédico
    .desc = El confiable cortavientos de un paramédico, para todo el viento espacial.

ent-ClothingOuterCoatSyndieCap = abrigo del Syndicate
    .desc = El abrigo del Syndicate está hecho de tela duradera, con patrones dorados.

ent-ClothingOuterCoatSyndieCapArmored = abrigo blindado del Syndicate
    .desc = El abrigo blindado del Syndicate está hecho de tela duradera, con patrones dorados.
...
ent-ClothingOuterCoatLabSeniorResearcher = bata de investigador senior
