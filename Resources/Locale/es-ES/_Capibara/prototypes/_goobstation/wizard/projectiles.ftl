...
ent-ProjectileDeathBolt = rayo de la muerte
    .desc = Ya estás muerto, solo que aún no lo sabes.

ent-ProjectileTeleBolt = rayo de teletransportación
    .desc = No parpadees o te perderás a ti mismo teletransportándote.

ent-ProjectileFieryBolt = rayo ígneo
    .desc = Para, tírate al suelo y rueda.

ent-ProjectileIceCubeBolt = rayo de hielo
    .desc = Te hará deslizar.

ent-ProjectileSwapBolt = rayo de intercambio
    .desc = Bailemos.

ent-ProjectileBeeBolt = rayo de abejas
    .desc = ¡NO LAS ABEJAS!

ent-ProjectileXRayBolt = rayo de rayos X
    .desc = Las paredes no son un obstáculo.

ent-ProjectileEmpBolt = rayo electromagnético
    .desc = ¡Energía baja!

ent-ProjectileSmokeBolt = rayo de humo
    .desc = No lo inhales.

ent-ProjectileBlindingBolt = rayo cegador
    .desc = Sigue el olfato.

ent-ProjectileVampiricBolt = rayo del vampirismo
