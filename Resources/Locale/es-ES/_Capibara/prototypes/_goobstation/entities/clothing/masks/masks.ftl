...
ent-ClothingMaskGasHalf = semimáscara de gas
    .desc = Una máscara de gas... solo la mitad.

ent-ClothingBSOMaskGasSwat = máscara de gas SWAT del escudo azul
    .desc = Una máscara de gas de dotación estándar para Oficiales del Escudo Azul.
