ent-PlushieLouie = peluche de louie
    .desc = Un adorable peluche que se parece a una rata. Sientes una extraña compulsión de saludar a la rata.

ent-FoamThrongler = Throngler de espuma
    .desc = No el Throngler que querías, pero el Throngler que mereces.

ent-PlushieDurk = peluche de Durk
...
ent-FoamWonderprod = Wonderprod de juguete
    .desc = Usar esto hará que seguridad te mate.

ent-PlushieBingle = peluche gigante de bingle
    .desc = Un adorable peluche que se parece a un alienígena azul. Sientes una extraña compulsión de decir bingle.

ent-PlushieBingleSmall = peluche de bingle
    .desc = Un adorable peluche que se parece a un alienígena azul. Sientes una extraña compulsión de decir bingle.

ent-PlushieBingleYakub = peluche de bingle yakub
    .desc = Un adorable peluche que se parece a un alienígena azul. Sientes una extraña compulsión de decir bingle.

ent-PlushieBongle = peluche de bongle
    .desc = Un adorable peluche que se parece a un alienígena rojo. Sientes una extraña compulsión de decir bongle.

ent-PlushieBinglePony = peluche de poni bingle
    .desc = Un adorable peluche que se parece a un alienígena azul. Sientes una extraña compulsión de decir bingle.

ent-PlushieAbductor = peluche alienígena
    .desc = Glorp Zap Zeeble Glarp "Peluche" Bleeble
...
ent-PlushieSamantha = peluche de jane blueshield
    .desc = Un adorable peluche que se parece a una veterana oficial blueshield. Sientes un repentino antojo de piruletas al sostenerlo.

ent-PlushieJvne = peluche de jvne
    .desc = Ha sido un día duro...

ent-PlushieFern = peluche de lagarto místico
    .desc = Sientes que algo más te está mirando... justo fuera de tu campo de visión, en las sombras.

ent-PlushieNigel = peluche apuesto
    .desc = Huele a grandeza, y a un olor inconfundible a perfume de la marca adalamin.

ent-PlushieBrizby = peluche de Brizby
    .desc = Siempre admitirá ser malvado.

ent-PlushieBaldzby = peluche de Baldzby
    .desc = Ahora la verdad está a la vista de todos.

ent-PlushieBoggle = peluche de Boggle
    .desc = Puedes sentir dinero dentro.

ent-PlushieLehmin = peluche de Lehmin
    .desc = Huele a químicos, te sientes inquieto al sostenerlo.

ent-PlushieMnwaar = peluche de Mnwaar
...
ent-PlushieXeve = peluche de Xeve Byrd
    .desc = Ese maldito byrd que odio.

ent-PlushieTheHolyCrusader = peluche del Santo Cruzado
    .desc = El tipo más santo que conocerás jamás.

ent-DiscoBeachBall = pelota de playa disco
    .desc = Una pelota de playa disco convierte cualquier día de playa en Studio 54.

ent-ThronglerToy = El Throngler
    .desc = ¿Por qué harías esto?

ent-PlushiePasha = peluche de vox cansado
    .desc = Un peluche no tan adorable que se parece a un Vox agotado. Huele fuertemente a nicotina.

ent-PlushieLeguia = una sola anguila
    .desc = Criatura dudosa.

ent-PlushieWachtel = peluche de grug
...
ent-PlushieTwofish = peluche de TwoFish
    .desc = Mirándolo de cerca, parece un cretino.
