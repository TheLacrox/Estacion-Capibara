ent-XenobioVolatileOrgan = órgano volátil
    .desc = Una masa pulsante de slime que parece reaccionar a dispositivos cercanos.

ent-XenobioGoopBall = bola de goo
...
ent-XenobioAdamantineBar = barra de adamantita
    .desc = Teóricamente, si vendieras un par de estas, no necesitarías trabajar más en la estación. Debe de tener su utilidad, ya que cuesta una fortuna conseguir una. Pero, ¿dónde?
