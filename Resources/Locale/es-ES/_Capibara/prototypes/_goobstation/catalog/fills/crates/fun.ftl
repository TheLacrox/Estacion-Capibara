ent-CrateFunATV = Caja de ATV
    .desc = Un Vehículo Absolutamente Gravable para ayudar a carga con el transporte.
...
ent-CrateWizardAnomCore = Caja del Encantamiento
    .desc = Una caja que contiene núcleos de anomalía robados, usados para encantar.
