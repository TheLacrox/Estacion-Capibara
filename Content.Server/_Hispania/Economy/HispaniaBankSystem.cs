...
/// <summary>
/// Core banking system for the Hispania economy.
/// Manages bank accounts on ID cards, handles deposits/withdrawals,
/// and sets initial balances at player spawn.
/// </summary>
public sealed partial class HispaniaBankSystem : SharedHispaniaBankSystem
{
    ...
    {
        base.Initialize();
        _log = Logger.GetSawmill("hispania.bank");
